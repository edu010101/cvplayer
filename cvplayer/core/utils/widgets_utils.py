from cvplayer.core.utils import layout_utils, stylesheet_utils
from PyQt6.QtWidgets import QWidget, QLayout
from PyQt6.QtCore import Qt


def start_widget_basics(widget: QWidget, layout: QLayout = None, css_path: str = None, tool_tip: str = None, minimum_width: int=None, minimum_height: int=None, fixed_width: int=None, fixed_height: int=None, alignment: Qt.AlignmentFlag = None):
    ...
    if alignment!=None and layout!=None:
